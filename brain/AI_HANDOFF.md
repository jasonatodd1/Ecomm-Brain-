...
- `brain/supabase/migrations/` — `0001_init.sql`, `0002_rls.sql`, `0003_opportunities_unique_name.sql`, `0005_foundation_schemas.sql`, `0006_listings_monitoring.sql`, `0007_assets.sql`, `0008_assets_artwork_flat.sql`, `0009_opportunities_whitespace.sql` (0004 absent)
...
| Scoring | **Built; Pass A/B/C + white-space triangulation** | Seeds + Reddit + Trending Now → opportunities; `score:whitespace --limit=40` gap-scores top-N by demand. |
